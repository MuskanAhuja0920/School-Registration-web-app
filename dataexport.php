...
$DB_TBLName = "student"; //mysqli Table Name   
$filename = "studentdata";         //File Name
/*******YOU DO NOT NEED TO EDIT ANYTHING BELOW THIS LINE*******/    
//create mysqli connection   
$sql = "Select * from $DB_TBLName order by class1,id,dob,gender,brosis ";
...

{
    ...
    $sheet->getStyle('A1:AK1')->getFont()->setBold(true)->setSize(16);
